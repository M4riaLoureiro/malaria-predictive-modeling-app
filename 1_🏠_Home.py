...
st.markdown("""
            ...
            5. Valuable contribution towards the overarching objective of malaria elimination in Liberia.</div>
            """)
...
st.markdown(
            ...
            <div class="tab" style="text-align=justify;">The goal of this project is to develop an AI-powered app that utilizes predictive modeling and forecasting techniques to enhance malaria prevention efforts in Liberia. The app should incorporate three key functionalities:
            <p></p>
...
st.markdown("""
            ...
            - **Identifying environmental and social determinants of malaria**: Analyze large datasets to identify factors that contribute to malaria transmission and vulnerability, informing broader interventions.
            """)
st.markdown(
            """
            <style>
            ...
            <div class="tab" style="text-align=justify;">The development of an AI-powered app for predictive modeling and forecasting of malaria prevention in Liberia will require a range of AI tools and technologies. Here are some of the key tools that will be needed:
            <p></p>
...
st.markdown("""
            ...
            - **Data visualization tools**: These tools will be used to display the results of the AI analyses in a user-friendly way, such as using maps, charts, or graphs. This will make it easier for public health officials and other users to understand the information and act. </div>
            """)
